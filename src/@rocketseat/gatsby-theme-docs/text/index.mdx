...
izm ("Lion" 🦁 in Amazigh dialect) is a Highly maintainable & modular NodeJS project architecture.
Unlike other boilerplates, izm comes packed with features and best pratices to speed up the developement workflow
