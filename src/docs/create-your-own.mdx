...
To show you how functional modules work under the hood we will go with the third approach, in your text editor go under `/modules` and create a new folder call it `todo` you can call it whatever seems fit but we'll be making a todo module.
